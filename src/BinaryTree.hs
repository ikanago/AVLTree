...
data (Ord a, Eq a) => BinaryTree a = Nil | Node a (BinaryTree a) (BinaryTree a) 
    deriving (Show)
...
insert x (Node a lhs rhs) | x == a = Node x lhs rhs
...
searchMin :: (Ord a) => BinaryTree a -> a
